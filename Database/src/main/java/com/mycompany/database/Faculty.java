...
public class Faculty {
	...
	private static int prevFacID = 1;
	...
	static void edit(ArrayList<Faculty> faculties) {
		...
		var facultys = new Object() {
			Faculty facu = faculties.get(0);
		}; // Define a variable to hold the seleceted faculty
	...
	public Faculty(String name, String email, String buildingName, int officeNumber, long phoneNumber,
	...
	public Faculty(int id, String name, String email, String buildingName, int officeNumber, long phoneNumber,
			String department, String position) {
	...
	public void editFaculty(String name, String email, String buildingName, int officeNumber, long phoneNumber,
			String department, String position) {
